...
class LinkedInData(object):
    ...
    def return_value_all(self):
        ...
        self.past_job_title7, self.past_job_org_summary7, self.past_job_org_detail7,
        # self.past_job_duration7,
        self.past_job_location7,
        self.past_job_description7,
        self.past_job_title8, self.past_job_org_summary8, self.past_job_org_detail8,
        # self.past_job_duration8,
        self.past_job_location8,
        self.past_job_description8,
        self.past_job_title9, self.past_job_org_summary9, self.past_job_org_detail9,
        # self.past_job_duration9,
        self.past_job_location9,
        self.past_job_description9,
        self.past_job_title10, self.past_job_org_summary10, self.past_job_org_detail10,
        # self.past_job_duration10,
        self.past_job_location10,
        ...
        # self.otherLevel_universityName4,
        self.otherLevel_degree4, self.otherLevel_major4,
        # self.otherLevel_endDate4,
        self.otherLevel_detail4,
        # self.otherLevel_universityName5,
        self.otherLevel_degree5, self.otherLevel_major5,
        # self.otherLevel_endDate5,
        self.otherLevel_detail5,
        # self.otherLevel_universityName6,
        self.otherLevel_degree6, self.otherLevel_major6,
        # self.otherLevel_endDate6,
        self.otherLevel_detail6,
        # self.otherLevel_universityName7,
        self.otherLevel_degree7, self.otherLevel_major7,
        # self.otherLevel_endDate7,
