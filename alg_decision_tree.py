...
def calculate_decision_tree(X_train, Y_train, X_test, Y_test,sum_index,top_index):
    ...
    globalparameter.alg_precision[sum_index + 6] = globalparameter.alg_precision[sum_index + 6] + precision_atn
    globalparameter.alg_recall[sum_index + 6] = globalparameter.alg_recall[sum_index + 6] + recall_atn