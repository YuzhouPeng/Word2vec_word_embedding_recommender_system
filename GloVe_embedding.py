...
import meanembedding, tf_idf_embedding
...
for i in range(6):
    ...
    for j in range(5):
        ...
        alg_logestic_regression.calculate_logistic_regression(X_train_vectorized, Y_train, X_test_vectorized, Y_test, i * 8)
        alg_logestic_regression.calculate_logistic_regression_cv(X_train_vectorized, Y_train, X_test_vectorized, Y_test,
                                                                 i * 8)
        alg_svm.calculate_svm_linear_svc(X_train_vectorized, Y_train, X_test_vectorized, Y_test, i * 8)
        alg_svm.calculate_svm_nusvc(X_train_vectorized, Y_train, X_test_vectorized, Y_test, i * 8)
        alg_svm.calculate_svm_svc(X_train_vectorized, Y_train, X_test_vectorized, Y_test, i * 8)
        alg_bayes.calculate_bayes(X_train_vectorized, Y_train, X_test_vectorized, Y_test, i * 8)
        alg_decision_tree.calculate_decision_tree(X_train_vectorized, Y_train, X_test_vectorized, Y_test, i * 8)
        alg_ramdom_forest.calculate_random_forest(X_train_vectorized, Y_train, X_test_vectorized, Y_test, i * 8)
...
result_list.to_csv('/Users/pengyuzhou/Downloads/word2vec_average_sentence_result/all_result_list.csv')
